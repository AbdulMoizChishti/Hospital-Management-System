...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Hospital 1.png"))); // NOI18N
...
//        loadPassword();
        if ((user.equals("admin")) && (pass.equals("admin") )) {
            ...
            JOptionPane.showMessageDialog(jButton1, "Login Successful", "Hospital Management System", 2);
            this.setVisible(false);
            Dashboard menu = new Dashboard();
            menu.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(jButton1, "Login Failed", "Hospital Management System", 2);
            uname.setText("");
            pword.setText("");
        }
